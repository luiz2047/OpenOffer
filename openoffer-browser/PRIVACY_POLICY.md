# Privacy Policy for OpenOffer Companion

*Last Updated: June 13, 2026*

OpenOffer ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how the OpenOffer Companion Chrome Extension handles user data.

---

## 1. Information Collection and Use

The OpenOffer Companion Chrome Extension **does not collect, store, or transmit any personal data, tracking information, or browsing history** to OpenOffer or any third-party servers.
...
- **Local Transmission Only:** The extracted content is sent directly to your locally running OpenOffer desktop application via a secure local loopback connection (`http://127.0.0.1` and `ws://127.0.0.1`).
...
- **Host Permissions (`http://127.0.0.1/*`, `ws://127.0.0.1/*`):** Needed to send data to the OpenOffer desktop application running on your computer.
