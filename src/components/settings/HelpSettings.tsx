    ...
    return (
        <div className="flex justify-center flex-col items-center gap-4 py-8 bg-bg-card rounded-xl border border-border-subtle relative overflow-hidden h-[240px]">
            ...
            <div className="text-xs text-text-secondary text-center max-w-[280px]">
                {isMac
                    ? 'OpenOffer requires Accessibility and Screen Recording permissions to analyze screen context.'
                    : 'OpenOffer will ask for microphone access the first time you start a meeting.'}
            </div>
        </div>
    );
};
    ...
    const steps = [
        {
            ...
            desc: isMac
                    ? 'Enable Screen Recording and Accessibility for OpenOffer in macOS Privacy & Security.'
    ...
    return (
        <div className="mb-10">
            <div className="mb-7">
                ...
                <p className="text-[13px] text-text-tertiary mt-0.5">Get OpenOffer running in four steps.</p>
            </div>
            ...
            <div className="flex-1 space-y-2">
                ...
                <AccordionSection title="1. App Permissions Setup" icon={<Monitor className="w-4 h-4" />}>
                    <div className="space-y-4">
                        <p>
                            {isMac
                                ? 'OpenOffer operates entirely on-device, but requires OS permissions to tap into your screen context and global keystrokes. Here is how your system should look:'
                                : 'OpenOffer operates entirely on-device. Windows will prompt you for microphone access the first time you start a meeting — no other OS permissions are required.'}
                        </p>
                        ...
                        <div className="space-y-3 mt-4">
                            ...
                            <div className={`p-4 rounded-xl border bg-bg-item-surface border-border-subtle space-y-2`}>
                                ...
                                <p className="text-[11px] opacity-90 leading-relaxed text-text-secondary">
                                    OpenOffer can capture both what you say and what you hear globally. At the top of the Audio Settings, use the Dropdowns to explicitly select your hardware Input (e.g. your physical microphone) and Output capture (what the speakers play). By default, OpenOffer utilizes the <strong>System Default</strong>, so audio routing will automatically follow your OS preferences.
                                </p>
                            </div>
                        ...
                        {isMac ? (
                            <div className="flex flex-col gap-3 mt-6">
                                <div className={`p-4 rounded-xl border bg-bg-item-surface border-border-subtle`}>
                                    ...
                                    <p className="text-xs opacity-90 mb-2">Provides OpenOffer the ability to read your screen temporarily when you capture context.</p>
                                ...
                                <div className={`p-4 rounded-xl border bg-bg-item-surface border-border-subtle`}>
                                    ...
                                    <p className="text-xs opacity-90 mb-2">Required for OpenOffer to detect the global keyboard shortcuts below, regardless of what window is focused.</p>
                ...
                <AccordionSection title="2. Audio STT Providers Setup (Microphone)" icon={<Mic className="w-4 h-4" />}>
                    <div className="space-y-6">
                        <p>OpenOffer supports over 8 different Audio engines to transcribe what you hear and say. From the Audio tab in settings, use the overarching dropdown to switch the active engine.</p>
                ...
                <AccordionSection title="3. AI Providers & Prompt Engine" icon={<Key className="w-4 h-4" />}>
                    <div className="space-y-4">
                        <p className="text-sm">OpenOffer uses Large Language Models (LLMs) to reason about your screen and audio context. You can configure cloud providers, local models, or fully custom endpoints.</p>
                        ...
                        <div className="space-y-3 pt-2">
                            ...
                            <div className="mt-2 bg-bg-item-surface p-4 rounded-xl border border-border-subtle shadow-sm flex gap-3">
                                ...
                                <p className="text-[11px] text-text-secondary leading-relaxed mt-0.5">
                                    <strong className="text-text-primary font-bold">Autonomous Registry Sync:</strong> OpenOffer uses a 14-day background sync clock (<span className="font-mono bg-bg-elevated border border-border-muted px-1.5 py-0.5 rounded text-[10px] text-text-primary shadow-[inset_0_-1px_0_rgba(0,0,0,0.1)]">v2/api/models</span>) to poll upstream APIs for supported models. If Anthropic or OpenAI drops a new flagship architecture, the provider list can be refreshed from settings.
                                </p>
                            </div>
                        ...
                        <div className="space-y-3 pt-4">
                            ...
                            <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle space-y-3">
                                <p className="text-xs opacity-90 leading-relaxed text-text-secondary">
                                    You can run OpenOffer completely offline with 100% data privacy using Ollama. OpenOffer automatically scans <span className={kbdClass}>http://localhost:11434</span> for active models.
                                </p>
                                <ol className="list-decimal pl-4 text-xs space-y-2 opacity-90 text-text-secondary">
                                    ...
                                    <li>Return to OpenOffer's AI Providers overlay, and you will see your local models ready for use.</li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle space-y-3">
                                ...
                                <div className="flex items-start gap-2 mt-2">
                                    ...
                                    <div className="text-xs text-text-secondary leading-relaxed">
                                        <strong>Crucial: The Response Path.</strong> You must tell OpenOffer how to parse the JSON text back. Deeply nested outputs must define the exact path array. For OpenAI/OpenRouter compliant endpoints, this is strictly: <span className={kbdClass}>choices[0].message.content</span>.
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <AccordionSection title="4. OpenOffer Interface Operations" icon={<Monitor className="w-4 h-4" />}>
                    <div className="space-y-6">
                        <p className="text-[13px]">When initialized, OpenOffer presents itself as a persistent translucent overlay. This is your command center.</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                            <div className="p-4 bg-bg-item-surface border border-border-subtle rounded-xl shadow-sm hover:border-border-muted transition-colors group">
                                ...
                                <p className="text-[12px] text-text-secondary leading-relaxed">
                                    OpenOffer fires a local background job as soon as the meeting finishes to compress the entire raw audio transcript into clean, formatted markdown representing structural overviews and explicit action items.
                                </p>
                            </div>
                ...
                <AccordionSection title="6. Global Search & Shortcuts" icon={<Search className="w-4 h-4" />}>
                    <div className="space-y-6">
                        <p className="text-[13px]">Hit <span className={kbdClass}>{isMac ? 'Cmd+K' : 'Ctrl+K'}</span> anywhere on your computer to invoke the OpenOffer Global Palette. This acts as your Spotlight overlay for interacting directly with the app.</p>
                        ...
                        <div className="border-t border-border-subtle pt-6">
                            ...
                            <p className="text-[11px] text-text-secondary mt-1 mb-3">These hotkeys work anywhere on your operating system, regardless of whether OpenOffer is focused or hidden. Change them via <strong>Settings &gt; Hotkeys</strong>.</p>
                                ...
                                <div className="flex items-center justify-between p-4 rounded-xl border bg-bg-item-surface border-border-subtle group">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-xs text-text-secondary mt-1">Triggers OpenOffer to analyze the captured screenshots and text from the rolling buffer.</div>
                                        </div>
                                    </div>
                                    <div className="flex gap-1 shrink-0">
                ...
                <AccordionSection title="8. Modes Manager" icon={<LayoutGrid className="w-4 h-4" />}>
                    <div className="space-y-6">
                        ...
                        <div className="p-3 bg-indigo-500/10 border border-indigo-500/20 rounded-xl">
                            ...
                            <p className="text-[11px] text-text-secondary leading-relaxed mb-0">
                                Modes are available to every user. Use built-in personas or create your own for repeatable meeting workflows.
                            </p>
                        </div>
                    </div>
                </AccordionSection>
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            <div className="p-3 bg-blue-500/10 border border-blue-500/20 rounded-xl mb-4">
                                ...
                                <p className="text-[11px] text-text-secondary leading-relaxed mb-0">
                                    By connecting your Google Calendar directly to OpenOffer, the AI gains context on your upcoming meetings, syncs the event data, and reads attendee lists to personalize your interactions.
                                </p>
                            </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-3">
                                <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle">
                                    ...
                                    <ul className="text-[11px] text-text-secondary space-y-1 list-disc pl-4">
                                        ...
                                        <li>OpenOffer will background-sync your schedule.</li>
                                    </ul>
                                </div>
                                <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle">
                                    <h4 className="font-semibold text-sm mb-2 text-text-primary">Follow-Up System</h4>
                                    <p className="text-[11px] text-text-secondary">
                                        When tracking live meetings, OpenOffer uses the connected calendar context to figure out who you are talking to. This powers the Follow-Up Email system, letting you draft post-meeting notes to confirmed attendees.
                                    </p>
                                </div>
                                <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle">
                                    <h4 className="font-semibold text-sm mb-2 text-text-primary flex items-center gap-2">
                    ...
                    <div className="space-y-4">
                        <div className="p-3 bg-sky-500/10 border border-sky-500/20 rounded-xl mb-2">
                            <h4 className="text-[13px] font-semibold text-sky-400 flex items-center gap-2 mb-1">
                                <Smartphone size={14} /> Stream OpenOffer to Your Phone
                            </h4>
                            <p className="text-[11px] text-text-secondary leading-relaxed mb-0">
                                Phone Mirror spins up a small local web server so you can watch OpenOffer's live transcript and AI answers from your phone or tablet — handy when your screen is being shared and you want a second view.
                            </p>
                        </div>
                ...
                <AccordionSection title="11. Stealth & Window Control" icon={<Ghost className="w-4 h-4" />}>
                    <div className="space-y-4">
                        <div className="p-3 bg-indigo-500/10 border border-indigo-500/20 rounded-xl mb-4">
                            ...
                            <p className="text-[11px] text-text-secondary leading-relaxed mb-0">
                                OpenOffer is geared towards power users seeking a compact, local-first workflow.
                            </p>
                        </div>
                        ...
                        <div className="grid gap-3">
                            ...
                            <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle group">
                                ...
                                <div className="p-2 border border-orange-500/20 bg-orange-500/5 rounded-lg">
                                    <p className="text-[10px] text-orange-400 m-0">
                                        <strong>⚠️ Warning:</strong> This renders the OpenOffer overlay completely unclickable. Use the Global Hotkeys (e.g. <strong>{isMac ? 'Cmd' : 'Ctrl'}+Shift+Arrows</strong> to move, <strong>{isMac ? 'Cmd' : 'Ctrl'}+B</strong> to hide, <strong>{isMac ? 'Cmd' : 'Ctrl'}+1-7</strong> for actions) to control the application once this is active.
                                    </p>
                                </div>
                            </div>
                        </div>
