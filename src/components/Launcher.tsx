                                ...
                                <div className="max-w-4xl mx-auto space-y-6">
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-4">
                                            <h1 className="text-3xl font-celeb-light font-medium text-text-primary tracking-wide drop-shadow-sm">My OpenOffer</h1>
                                        ...
                                        <motion.button
                                            onClick={() => {
                                                if (isMeetingActive) {
                                                    ...
                                                    // the OpenOffer app or steal OS focus — preserves stealth.
                                                    ...
                                                    onStartMeeting();
                                                    analytics.trackCommandExecuted('start_openoffer_cta');
                                                }
                                            }}
                                                ...
                                                <AnimatePresence mode="wait" initial={false}>
                                                    {isMeetingActive ? (
                                                        ...
                                                        >
                                                            ...
                                                            <span className="drop-shadow-[0_1px_1px_rgba(0,0,0,0.1)] text-[20px] leading-none">Start OpenOffer</span>
                                                        </motion.div>
                                                    )}
                                                </AnimatePresence>
                                            </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3 h-[198px]">
                                        {/* Default Intro — support and upcoming features.
