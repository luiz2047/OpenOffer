...
const NativelyInterface: React.FC<NativelyInterfaceProps> = ({
   ...
   * extension and the OpenOffer LLM pipeline. The extension captures the
  ...
  // cross-platform and should open OpenOffer's own Settings. Bundling
  ...
  // opening OpenOffer's internal Settings, which is one extra click and
...
Provide only the answer, nothing else.`;
  ...
  // intercepted at OS level -> keystrokes went to OpenOffer's read-only
                ...
                <div className="flex items-center justify-between mx-4 mt-3 mb-1 px-3.5 py-2.5 bg-yellow-500/10 border border-yellow-500/20 rounded-[12px] shadow-sm relative no-drag group/warning">
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    {/*
                      ...
                      mic-denied path opened OpenOffer's internal Settings,
                      which then required the user to read the message, alt-tab
                      to System Settings, navigate to Privacy & Security, find
                      Microphone, and toggle OpenOffer. Now one click takes them
