...
// HINDSIGHT_API_LLM_LITELLMROUTER_CONFIG. This is OpenOffer's LLM provider chain +
...
//
// PRIORITY (hosted control-plane is intentionally not part of this path — see docs/HINDSIGHT_LOCAL_SETUP.md):
