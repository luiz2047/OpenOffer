...
pgvector) so OpenOffer's HindsightClientAdapter can retain/recall against a real
...
def main():
    ...
    try:
        ...
        print(f"[hindsight-dev-server] set HINDSIGHT_BASE_URL={url} for OpenOffer")
