...
The release workflow verifies ad-hoc app signatures and DMG integrity for unsigned preview artifacts. When Apple Developer ID secrets are configured, the same workflow switches to signed mode and also verifies notarization and stapling.
