# Legacy archive: Phase 8 — STT Relay Observability, Telemetry & Alerts
...
> Historical observability writeup from the pre-OpenOffer hosted-control-plane era. Kept for provenance only.
**Inputs (binding):**
