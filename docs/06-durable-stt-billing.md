# Legacy archive: Durable STT Billing — Schema, RPCs, and the F2/F3/F5/F6/F7 Fixes

**Date:** 2026-06-13
**Status:** Implemented (Phase 6) — `migrations/003_stt_durable_billing.sql` + relay `usageStore.js` wiring + logic test harness
> Historical billing design note from the pre-OpenOffer hosted-control-plane era. Kept for provenance only.
**Inputs (binding):**
