...
> Legacy archive note: this relay testing writeup describes the pre-OpenOffer hosted-control-plane era. OpenOffer ships local/self-hosted only; hosted defaults are intentionally absent.
**Inputs (binding):**
