...
- For control-plane uploads, images are downscaled with Sharp to ≤768 px on
...
| 7 | P2 | No image-size cap before sending to Claude/OpenAI/Gemini | Reuse the Sharp resize already used for the control-plane path for every cloud path |
