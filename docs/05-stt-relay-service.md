# Legacy archive: Phase 5 — Standalone STT Relay Service (`services/stt-relay`)

**Date:** 2026-06-13
**Status:** Complete — 47/47 tests green, standalone boot verified, parent repo untouched
> Historical relay writeup from the pre-OpenOffer hosted-control-plane era. Kept for provenance only.
**Inputs (binding):**
