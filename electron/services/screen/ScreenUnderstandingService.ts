...
//
// VISION-FIRST screen understanding pipeline for OpenOffer.
//
// Flow:
//   request
    ...
    if (providers.length === 0) {
      ...
      return this.buildUnavailable({
        ...
        unavailableReason: mode === 'private_vision'
          ...
          : 'No vision-capable provider is configured. Add an API key for OpenAI, Claude, Gemini, or Groq, or configure a local Ollama vision model.',
      });
    }
