...
export class DatabaseManager {
    ...
    private constructor() {
        ...
        this.dbPath = path.join(userDataPath, 'openoffer.db');
...
OpenOffer is a free, open-source AI meeting assistant designed to help you stay focused, informed, and fast-moving during calls. Get live insights while you speak, instant answers to questions, and structured notes after every meeting.
...
- Show or hide OpenOffer at any time:
  - **Mac**: Cmd + B
  - **Windows**: Ctrl + B
...
- **Usage**: Track your interaction history and see how OpenOffer assisted you.
...
### Undetectability
Use **Undetectable Mode** to keep OpenOffer out of screen-sharing surfaces where supported.
...
**Once downloaded, return to Settings -> Credentials in OpenOffer and select this file to complete setup.**
...
https://github.com/luiz2047/openoffer`;
        ...
        const demoMeeting: Meeting = {
            id: demoId,
            title: "OpenOffer Demo & Guide",
            date: today.toISOString(),
            duration: "5:00",
            summary: "Complete guide to using OpenOffer - your real-time AI meeting assistant.",
            detailedSummary: {
            ...
            transcript: [
                { speaker: 'interviewer', text: "Welcome to OpenOffer! Let me show you how it works.", timestamp: 0 },
                ...
                { speaker: 'user', text: "How do I hide OpenOffer during screen share?", timestamp: 60000 },
            ...
            usage: [
                { type: 'assist', timestamp: 15000, question: 'What features does OpenOffer have?', answer: 'OpenOffer offers 5 quick action buttons, screenshot analysis, real-time transcription, and comprehensive meeting notes.' },
