...
const overlayResizeTracePath = '/tmp/openoffer-overlay-resize-trace.log';
...
export class WindowHelper {
  ...
  public createWindow(): void {
    ...
    const overlaySettings: Electron.BrowserWindowConstructorOptions = {
      ...
      // (and receive keystrokes for the chat input) without activating OpenOffer
    ...
    if (process.platform === 'darwin') {
      ...
      // ANY click on the overlay (button, input, anywhere) activates OpenOffer
  ...
  public toggleMainWindow(): void {
    if (this.isWindowVisible) {
      ...
      // Always show without stealing focus - OpenOffer is a ghost overlay.
